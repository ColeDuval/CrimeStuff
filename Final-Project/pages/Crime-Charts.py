...
st.write('This pie chart shows which hours of the day have the most crimes committed. This information could be very insightful especially for law enforcement agencies because it could help them meet the demand for officers during hours that have the highest number of crimes being committed')
st.subheader('What are the possible uses of this chart?')
...
st.subheader('What does this chart show?')
st.write('This bar chart is a visual representation of the total number of crimes committed within each hour of the day within a six-month period of time in Boston.  The range of hours can be manipulated by the user to zoom in on specific data.')
st.subheader('What are the possible uses of this chart?')
st.write('This bar chart shows which hours of the day have the most crimes committed. Again much like the pie chart this bar chart shows which hours of the day have the most crimes committed. It shows the hours of the day that have the least amount of crimes committed too.  Both of these pieces of information along with the trend they may show are extremely informative pieces of information for the police.')
...
st.subheader('What does this chart show?')
st.write('This line plot shows two different lines.  The red line represents the total aggregated number of crimes for each hour of the range specified by the end user.   The green line represents the average total crimes committed within the range specified by the user.')
st.subheader('What are the possible uses of this chart?')
st.write('By looking at the total crimes line (red) we can see the rate at which the total number of crimes Is changing, the steeper the slope, the higher change in the number of crimes per hour. We can see with the green line that on average the average number of total crimes is increasing due to the fact that the total amount of crime is increasing which causes the total average crimes per hour to increase as well.')
